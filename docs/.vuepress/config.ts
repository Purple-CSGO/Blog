...
const DOMAIN_NAME = "upup.cool"; // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    author: {
      name: "Purp1e", // 必需
      link: "https://github.com/Purple-CSGO", // 可选的
    },
  ...
  head: [
    ...
    [
      "meta",
      {
        name: "keywords",
        content:
          "视频制作,CSGO,集锦,技术博客,前端,vue,js,css,html,c,c++,go,golang,wails,github,b站,bilibili,视频编码",
      },
    ],
